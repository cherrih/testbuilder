...
describe('Discover', function() {
  ...
  it('has a prefix of 65 and a length of 16', function() {
     expect(detectNetwork('6571567890123456')).to.equal('Discover')
  });
  it('has a prefix of 65 and a length of 19', function() {
     expect(detectNetwork('6571567890123456789')).to.equal('Discover')
  });
});

describe('Maestro', function() {
 var expect = chai.expect;
 for (var nums = '12345678'; nums.length <= 15; nums += '0') {
   (function(param) {
...
describe('China UnionPay', function() {
  ...
  for (var prefix = 624; prefix <= 626; prefix ++){
    var nums1 = '1234567890123';
      for (var howLong = 16; howLong <= 19; howLong++){
        (function(firstNums, len, actualNum) {
          it('has a prefix of '+ String(firstNums) + ' and a length of ' + String(len), function() {
            expect(detectNetwork(String(firstNums) + actualNum)).to.equal('China UnionPay');
        });
        })(prefix, howLong, nums1)
        nums1 += '1';
      }
  }
  ...
  for (var prefix = 622126; prefix <= 622925; prefix ++){
    ...
    })(prefix, howLong, nums2)
    nums2 += '1';
    }
  }
  
  for (var prefix = 6282; prefix <= 6288; prefix ++){
    var nums3 = '123456789012';
    for (var howLong = 16; howLong <= 19; howLong++){
